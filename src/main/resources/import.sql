...
INSERT INTO `user_permissions` (`action`, `name`, `parentId`, `type`) VALUES ( 'test', '目录', 0, 'menu');
INSERT INTO `user_roles` (`code`, `name`) VALUES ('admin', '超级管理员');
INSERT INTO `user_relations` ( `userId`, `permissionId`, `roleId`) VALUES ( 1, 1, 1);
